...
describe('AddCommentUseCase', () => {
  it('should throw error when payload not contain needed property', async () => {
    ...
    await expect(addCommentUseCase.execute({}, 'thread-123', 'user-123'))
      .rejects
  ...
  it('should orchestrate add comment action correctly', async () => {
    ...
    expect(mockCommentRepository.addComment).toBeCalledWith(expect.any(Object), 'thread-123', 'user-123');
  });
});
